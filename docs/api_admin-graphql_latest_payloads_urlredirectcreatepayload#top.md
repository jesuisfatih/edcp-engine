# Source: https://shopify.dev/docs/api/admin-graphql/latest/payloads/urlredirectcreatepayload#top
...
[Anchor to UrlRedirectCreatePayload](/docs/api/admin-
graphql/latest/payloads/urlredirectcreatepayload#top)
...
graphql/latest/payloads/urlredirectcreatepayload#fields)Fields

[Anchor to urlRedirect](/docs/api/admin-
graphql/latest/payloads/urlredirectcreatepayload#fields-
...
graphql/latest/payloads/urlredirectcreatepayload#fields-userErrors)userErrors

•[[UrlRedirectUserError!]!](/docs/api/admin-
graphql/latest/objects/UrlRedirectUserError)
...
[Anchor to Mutations with this payload](/docs/api/admin-
graphql/latest/payloads/urlredirectcreatepayload#mutations-with-this-
payload)Mutations with this payload

[Anchor to urlRedirectCreate](/docs/api/admin-
graphql/latest/payloads/urlredirectcreatepayload#mutation-
...
### Mutations with this payload
  ...
  * [urlRedirectCreate](/docs/api/admin-graphql/latest/types/urlRedirectCreate)
